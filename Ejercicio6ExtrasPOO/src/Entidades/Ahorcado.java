...
public class Ahorcado {
    ...
    private int jugadas, vidas;
    private String vectorAhorcado[];

    
    public Ahorcado() {
    }

    public Ahorcado(String frase, int cantLetrasEncontradas, int jugadas, int vidas) {
        this.frase = frase;
    ...
    public String[] getVectorAhorcado() {
        return vectorAhorcado;
    }

    public void setVectorAhorcado(String[] vectorAhorcado) {
        this.vectorAhorcado = vectorAhorcado;
    }

    @Override
    public String toString() {
        return "Ahorcado{" + "frase=" + frase + ", cantLetrasEncontradas=" + cantLetrasEncontradas + ", jugadas=" + jugadas + ", vidas=" + vidas + ", vectorAhorcado=" + vectorAhorcado + '}';
    }
