 ...
 */
package ejercicio6extraspoo;

import Entidades.Ahorcado;
import ServiciosAhorcado.Servicio;
import java.util.Arrays;

public class Ejercicio6ExtrasPOO {
    ...
    public static void main(String[] args) {
        ...
        sa.crearJuego(a);
//        for (String vectorAhorcado : a.getVectorAhorcado()) {
//            System.out.print(vectorAhorcado);
//        }
//        System.out.println("  ");
        v = sa.iniciarVectorAhorcado(a);
        do {
            System.out.println("------------------------");
            ...
            if (( Arrays.equals(v, a.getVectorAhorcado()))) {
                break; 
            }
        } while (a.getJugadas() !=0);
        if ( Arrays.equals(v, a.getVectorAhorcado())) {
            System.out.println("Felicidades ganaste el juego");
            System.out.println("La palabra o frase era: ");
             sa.mostrar(a, v);
        }else{
            System.out.println("Se te agotaron los intentos!:C");
        }
